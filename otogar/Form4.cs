...
namespace otogar
{
    public partial class Form4 : Form
    {
            ...
            else
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        if (!ReservationData.DoluKoltuklar.Contains(koltukno))
                        {
                            string queryy = "INSERT INTO altiAraci (isim, soyisim, koltuk,cinsiyet,numara) VALUES (@isim, @soyisim, @koltuk,@cins,@number)";
                            ...
                            if (koltukara != null)
                            {
                                ...
                                ReservationData.DoluKoltuklar.Add(koltukno);
                                ReservationData.KoltukBilgileri[koltukno] = (ad, soyad, rdkadin.Checked ? "Kadin" : "Erkek");
                ...
                else
                {
                    if (ReservationData.DoluKoltuklar.Contains(koltukno))
                    {
                        ...
                        if (koltukara != null)
                        {
                            ...
                            ReservationData.DoluKoltuklar.Remove(koltukno);
                            ReservationData.KoltukBilgileri.Remove(koltukno);
                            ...
                            string deleteQuery = "DELETE FROM altiAraci WHERE koltuk = @k";
        ...
        private void Form4_Load_1(object sender, EventArgs e)
        {
            ...
            conn.Open();
            string query = "Select * from altiAraci";
            ...
            while (reader.Read())
            {
                ...
                if (!ReservationData.DoluKoltuklar.Contains(reader.GetInt32(2)))
                {

                    ReservationData.DoluKoltuklar.Add(reader.GetInt32(2));
                    ReservationData.KoltukBilgileri[reader.GetInt32(2)] = (reader.GetString(0), reader.GetString(1),reader.GetString(3));
            ...
            dolukoltuk = ReservationData.DoluKoltuklar.Count;
            boskoltuk = 31 - dolukoltuk;

            foreach (var koltuk in ReservationData.DoluKoltuklar)
            {
                var info = ReservationData.KoltukBilgileri[koltuk];
