...
namespace otogar
{
    public partial class Form6 : Form
    {
            ...
            else
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        if (!ReservationData3.DoluKoltuklar.Contains(koltukno))
                        {
                            string queryy = "INSERT INTO onikiAraci (isim, soyisim, koltuk,cinsiyet,numara) VALUES (@isim, @soyisim, @koltuk,@cins,@number)";
                            ...
                            if (koltukara != null)
                            {
                                ...
                                ReservationData3.DoluKoltuklar.Add(koltukno);
                                ReservationData3.KoltukBilgileri[koltukno] = (ad, soyad, rdkadin.Checked ? "Kadin" : "Erkek");
                ...
                else
                {
                    if (ReservationData3.DoluKoltuklar.Contains(koltukno))
                    {
                        ...
                        if (koltukara != null)
                        {
                            ...
                            ReservationData3.DoluKoltuklar.Remove(koltukno);
                            ReservationData3.KoltukBilgileri.Remove(koltukno);
                            ...
                            string deleteQuery = "DELETE FROM onikiAraci WHERE koltuk = @k";
        ...
        private void Form6_Load_1(object sender, EventArgs e)
        {
            ...
            conn.Open();
            string query = "Select * from onikiAraci";
            ...
            while (reader.Read())
            {
                ...
                if (!ReservationData3.DoluKoltuklar.Contains(reader.GetInt32(2))){

                    ReservationData3.DoluKoltuklar.Add(reader.GetInt32(2));

                    ReservationData3.KoltukBilgileri[reader.GetInt32(2)] = (reader.GetString(0), reader.GetString(1), reader.GetString(3));
            ...
            dolukoltuk = ReservationData3.DoluKoltuklar.Count;
            boskoltuk = 31 - dolukoltuk;

            foreach (var koltuk in ReservationData3.DoluKoltuklar)
            {
                var info = ReservationData3.KoltukBilgileri[koltuk];
